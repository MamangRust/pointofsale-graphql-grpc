...
func (s *roleService) Trashed(id int) (*response.RoleResponseDeleteAt, *response.ErrorResponse) {
	...
	so := s.mapping.ToRoleResponseDeleteAt(res)
...
func (s *roleService) Restore(id int) (*response.RoleResponseDeleteAt, *response.ErrorResponse) {
