...
func (c *roleServiceClient) TrashedRole(ctx context.Context, in *FindByIdRoleRequest, opts ...grpc.CallOption) (*ApiResponseRoleDeleteAt, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *roleServiceClient) RestoreRole(ctx context.Context, in *FindByIdRoleRequest, opts ...grpc.CallOption) (*ApiResponseRoleDeleteAt, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApiResponseRoleDeleteAt)
...
func (UnimplementedRoleServiceServer) TrashedRole(context.Context, *FindByIdRoleRequest) (*ApiResponseRoleDeleteAt, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TrashedRole not implemented")
}
func (UnimplementedRoleServiceServer) RestoreRole(context.Context, *FindByIdRoleRequest) (*ApiResponseRoleDeleteAt, error) {
